    ...
    return (
        <Container>
            ...
            <div style = {{textAlign: "center"}}>
                ...
                <br />
                <div style = {{textAlign: "center"}}><iframe src="https://aaany-assets.s3.amazonaws.com/2024/amu+picnic+2024/WhatsApp+Video+2024-07-19+at+10.53.22+AM.mp4" allow="accelerometer; encrypted-media; gyroscope; picture-in-picture" allowFullScreen style = {{width: "600px", height: "400px"}}></iframe></div>
            </div>
            <Footer />
        </Container>
    )
