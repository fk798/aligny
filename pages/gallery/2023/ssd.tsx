...
const videos = [
  { title: 'Speeches and Awards', id: 'LVC9nlde-cQ' },
  { title: 'Mushaira', id: 'TfoBoE1hPlE' },
  { title: 'Mushaira (short)', id: 'XEEMxjhj3aM' },
  { title: 'Anubhav Sinha Speech', id: 'VELN2OKMPyg' },
  { title: 'Anubhav Sinha Interview', id: 'pJbSPjVFLQI' },
  { title: 'AMU Tarana', id: 'Zzvj5uinxXk' },
  { title: 'Mushaira Interviews', id: '7kSP8O6Ih1Q' },
  { title: 'Urdu News', id: 'HdCD0UIpYXo' },
  { title: 'AMU Tarana', id: 'fr9fX3lBKv4' },
];
...
export default function SSD() {
  ...
  return (
    <>
      <Head>
        <title>Sir Syed Day 2023 — AAANY</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <Navigation />
      <Gallery images={images} title="AAANY Sir Syed Day 2023 Gallery" year="2023" />

      <section className="section">
        <div className="container-aaany" style={{ textAlign: 'center' }}>
          <span className="section-label" style={{ color: 'var(--color-accent)' }}>Media</span>
          <h2 style={{ fontFamily: 'var(--font-display)', marginBottom: '2.5rem' }}>
            Sir Syed Day 2023 Videos
          </h2>
          {videos.map((video, i) => (
